...
export default function ThemeSwitch() {
  ...
  return (
    <button
      className='relative block h-[22px] w-10 shrink-0 rounded-xl border border-slate-300 bg-slate-100 transition-colors hover:border-slate-400'
      type='button'
      role='switch'
      ...
      onClick={toggleTheme}
    >
      <span className='absolute top-px left-px h-[18px] w-[18px] rounded-full bg-white shadow transition-all duration-300 dark:translate-x-[18px]'>
        <span>
          <svg
            ...
            focusable='false'
            viewBox='0 0 24 24'
            className='absolute top-[3px] left-[3px] h-3 w-3 fill-slate-700 opacity-100 dark:opacity-0'
          >
          ...
          <svg
            ...
            focusable='false'
            viewBox='0 0 24 24'
            className='absolute top-[3px] left-[3px] h-3 w-3 fill-slate-700 opacity-0 dark:opacity-100'
          >
