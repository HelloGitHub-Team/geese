...
export default function ThemeSwitch() {
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
    >
      <span className='absolute top-px left-px h-[18px] w-[18px] rounded-full bg-white shadow transition-all duration-300 dark:translate-x-[18px] dark:bg-slate-800'>
        <span>
          <svg
            ...
            focusable='false'
            viewBox='0 0 24 24'
            className='absolute top-[3px] left-[3px] h-3 w-3 fill-slate-500 opacity-100 dark:opacity-0'
          >
          ...
          <svg
            ...
            focusable='false'
            viewBox='0 0 24 24'
            className='absolute top-[3px] left-[3px] h-3 w-3 fill-slate-400 opacity-0 dark:opacity-100'
          >
