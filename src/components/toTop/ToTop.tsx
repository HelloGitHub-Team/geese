...
export default function ToTop({ cb }: ToTopProps) {
  ...
  return (
    <div
      ...
      className='z-99 fixed bottom-10 right-10 flex h-12 w-12 cursor-pointer items-center justify-center rounded-full bg-white shadow-sm hover:shadow-md dark:bg-gray-800'
    >
