...
const MoreInfo: NextPage<RepositoryProps> = ({ repo }) => {
  ...
  return (
    <div className='relative mt-2'>
      ...
      {!isShowMore ? (
        <div
          className='trangray-y-full absolute right-3 bottom-0 cursor-pointer rounded-b-lg bg-gray-100 px-4 py-1 text-xs text-gray-400 hover:bg-gray-200 active:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:active:bg-gray-700 lg:right-9'
